...
exp = 'irataus'; % 'robotarium'; % 'corridor' %'outdoor_afternoon'
...
switch exp
    ...
    case 'outdoor_afternoon'
        ...
        theta = 60;
    case 'irataus'
        file = fullfile('experiments','irataus','irataus.bag');
        offset1 = 1;
        offset2 = 1;
        theta = 60;
    otherwise
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% data_em = select(bag,'Topic','/irat_aus/ExperienceMap/Map');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
data_em_pose = select(bag,'Topic','/irat_red/ExperienceMap/RobotPose');
