...
% 'robotarium_ratslam', 'robotarium_neoslam', 'corridor',
% 'outdoor_afternoon' outdoor_afternoon_ratslam
exp = 'robotarium_ratslam';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
switch exp
    case 'robotarium_ratslam'
        %file = fullfile('experiments','robotarium_ratslam','_2023-09-17-15-44-55_0.bag');
        file = fullfile('experiments','robotarium_ratslam','ratslam_robotarium_features.bag');
        %file = fullfile('experiments','robotarium_ratslam','ratslam_robotarium_features_complete.bag');
    ...
    case 'outdoor_afternoon'
        file = fullfile('experiments','outdoor_afternoon','_2023-09-29-10-10-04_0.bag');
        offset1 = 1;
        offset2 = 1;
        theta = 60;
        figure2_process = 1;
    case 'outdoor_afternoon_ratslam'
        %file = fullfile('experiments','outdoor_afternoon_ratslam','_2023-09-17-16-51-54_0.bag');
        %file = fullfile('experiments','robotarium_ratslam','ratslam_outdoor_features_complete.bag');
        file = fullfile('experiments','outdoor_afternoon_ratslam','ratslam_outdoor_features.bag');
        offset1 = 1;
        offset2 = 1;
        theta = 60;
        figure2_process = 0;
        ratslam_var = 1;
    case 'irataus'
        %file = fullfile('experiments','irataus','irataus_small.bag');
        file = fullfile('experiments','irataus','irataus_features_01.bag');
        offset1 = 1;
        offset2 = 1;
        theta = 60;
        figure2_process = 0;
